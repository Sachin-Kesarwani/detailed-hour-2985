...
useEffect(()=>{
    ...
    return(
        ...
        <Grid  style={{margin:"auto",display:"grid",width:"80%",gridTemplateColumns:`repeat(${col},1fr)`}}>
   {
    arr.map((e,i)=>{
    return    <Skeleton key={i} borderRadius={8} marginTop={5} w={`${SkeletonWth}vw`} h={`${SkeletonHth}vw` }/>
    })
   }
