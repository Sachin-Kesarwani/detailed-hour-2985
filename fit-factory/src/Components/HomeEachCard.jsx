...
border={" 1px solid  #c2c2d6"}
      ...
      >
        ...
        <Box p={4}>
            <Flex>
            <Badge fontSize={"12px"} padding={"5px 10px"} variant='solid' borderRadius={"3px"} bg={"teal.300"} colorScheme='white'>
             5.00    <Icon as={StarIcon} color='white' />
        
            </Badge>
            <Spacer/>
            <Text fontSize={"14px"} color={"gray.500"}>100 reviews</Text>
            <Spacer/>
        ...
        <Spacer/>
        <Text fontSize='sm'><del> ₹300</del></Text>
        <Spacer/>
        <Text fontSize='sm' color={"green.600"} > 40% OFF</Text>
        <Spacer/>
        <Spacer/>   <Spacer/>
        </Flex>
        <Box     cursor={"pointer"} bg={"blackAlpha.100"} padding={"5px 15px"}  borderRadius={"5px"} marginTop={"10px"} marginBottom={"10px"} >
            <Text textAlign={"center"}><Icon as={StarIcon} color={"orange.500"}/>  dgfehggrjuhr
