...
import { GetOrderdatafromjson, PostdataIncart, PostdataInOrder } from "../Redux/CartRedux/action";
...
if(paymentdata.name!="" && paymentdata.email!=""&&paymentdata.card!=""&&paymentdata.card.length==16&&paymentdata.cvv!=""&&paymentdata.cvv.length==3&&paymentdata.mon!=""&&paymentdata.year!=""){
...
=======
     ...
     Valid thru :
        <select  onChange={paymentformdata} name="mon"  value={paymentdata.mon} >
>>>>>>> d85254b2020c2e411f7b45ddff3924b9ae75ee2d
            <option>MM</option>
