...
export const DelelteProduct =(endpoint,id)=>(dispatch)=>{
  dispatch({ type: types.Loading });
  axios.delete(`https://helpful-free-baroness.glitch.me/${endpoint}/${id}`)
  .then((res)=>{
...
export const EditProduct =(endpoint,id,obj)=>(dispatch)=>{
  dispatch({ type: types.Loading });
  axios.patch(`https://helpful-free-baroness.glitch.me/${endpoint}/${id}`,obj)
  .then((res)=>{
...
export const Addproduct =(endpoint,obj)=>(dispatch)=>{
  dispatch({ type: types.Loading });
  axios.post(`https://helpful-free-baroness.glitch.me/${endpoint}`,obj)
  .then((res)=>{
