...
const SinglePage = () => {
  ...
  function Getdata(){
   let url
    if(title=="flashsale"||title=="topDeals"||title=="fitfoods"||title=="wellness&personel"||title=="workoutEssential"){
...
useEffect(()=>{
  ...
  return loading?<Heading>Loading ...</Heading>:(
    <div>
...
return <SingleCard  item={e} />
       ...
       <hr style={{ border: "3px solid #c2c2d6", marginTop: "40px",marginBottom:"10px" }}></hr>
       
       <Heading textAlign={"center"} fontSize='xl'>Supplemnet Info</Heading>
       ...
       <hr style={{ border: "3px solid #c2c2d6", marginTop: "20px",marginBottom:"10px" }}></hr>
